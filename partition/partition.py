...
class Partition:
    ...
    def compute_densities(self, partition_B, density_function, return_differences=False):
        ...
        if return_differences:
            args["return_differences"] = return_differences
    ...
    def classify(self, partition_B, density_function, verbose=False, return_differences=False):
        ...
        densities = self.compute_densities(partition_B, density_function)
        if return_differences:
            densities, differences = self.compute_densities(partition_B, density_function, return_differences=return_differences)
        '''
        ...
        if return_differences:
            return classification, densities, differences
